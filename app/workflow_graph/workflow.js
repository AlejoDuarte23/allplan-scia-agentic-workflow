  ...
  constructor({ stage, edgesSvg, nodesHost, overlayEl, logEl }) {
    ...
    this.typeStyles = {
      ...
      allplan_model: {
        bg: "#D8F3DC",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" style="width: 40px; height: 40px;">
          <rect x="2" y="2" width="40" height="40" rx="10" ry="10" fill="#2D6A4F"/>
          <text x="22" y="26" fill="white" font-family="system-ui" font-size="22" font-weight="700" text-anchor="middle" dominant-baseline="middle">A</text>
        </svg>`
      },
      scia_model: {
        bg: "#DDE7FF",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" style="width: 40px; height: 40px;">
          <rect x="2" y="2" width="40" height="40" rx="10" ry="10" fill="#3157A4"/>
          <text x="22" y="26" fill="white" font-family="system-ui" font-size="22" font-weight="700" text-anchor="middle" dominant-baseline="middle">S</text>
        </svg>`
      },
      viktor_api_tool: {
        bg: "#FFE8CC",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" style="width: 40px; height: 40px;">
          <rect x="2" y="2" width="40" height="40" rx="10" ry="10" fill="#D9480F"/>
          <text x="22" y="26" fill="white" font-family="system-ui" font-size="20" font-weight="700" text-anchor="middle" dominant-baseline="middle">V</text>
        </svg>`
      },
      workflow_step: {
        bg: "#E7F5FF",
      ...
      custom_step: {
        bg: "#F1F3F5",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M12 3l1.9 5.8H20l-4.9 3.6L17 18.2l-5-3.6-5 3.6 1.9-5.8L4 8.8h6.1L12 3z"></path>
        </svg>`
      },
      default: { 
        bg: "#E5E5E5",
